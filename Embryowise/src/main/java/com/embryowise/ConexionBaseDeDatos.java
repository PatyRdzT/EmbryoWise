...
/** En esta clase es donde se establece la conexión con la base de datos.
 * */
public class ConexionBaseDeDatos {
    // Se le pasa la url de la BD con el usuario y contraseña para manejarla.
    private static final String URL = "jdbc:mysql://localhost:3306/embryowisedatabase";
    private static final String USER = "root";
    private static final String PASSWORD = "241216073110koko*";

    // Se crea una conexión, en caso de fallar, se lanza una excepción SQL. Se pasan los
    // parámetros antes declarados.
