...
public class PantallaInicio {
    ...
    public void mostrar(Stage stage) { // (8)
        ...
        Image fondoPantallaInicio = new Image(getClass().getResource("/Recursos" +
        ...
        *  de 70px, y estableciendo como fondo la imagen antes cargada. */
        ...
        Scene escena = new Scene(panelPrincipal); // (12)
        ...
        botonIniciar.setOnAction(e -> new MenuPrincipal().mostrar(stage)); // (13)
